...
(function() {
  ...
  Odometer = (function() {
    ...
    Odometer.prototype.render = function(value) {
      ...
      if(_ref.length < this.options.numberLength){
        for(let i = 0; i< this.options.numberLength - _ref.length; i++){
          _newref.push('0')
        }
      }
    ...
    Odometer.prototype.animateSlide = function(newValue) {
       ...
       * todo 解决补零动画问题
       *
       * this.options.numberLength 替换了 digitCount字段
       */
      for (i = _i = 0; 0 <= this.options.numberLength ? _i < this.options.numberLength : _i > this.options.numberLength; i = 0 <= this.options.numberLength ? ++_i : --_i) {
        start = truncate(oldValue / Math.pow(10, this.options.numberLength - i - 1));
        end = truncate(newValue / Math.pow(10, this.options.numberLength - i - 1));
        dist = end - start;
